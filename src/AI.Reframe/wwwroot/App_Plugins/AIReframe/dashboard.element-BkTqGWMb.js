...
import { c as l } from "./client.gen-aGN3fyVl.js";
class d {
  static ping(e) {
    return (e?.client ?? l).get({
      ...
      url: "/umbraco/aireframe/api/v1/ping",
      ...e
    });
  }
  static whatsMyName(e) {
    return (e?.client ?? l).get({
      ...
      url: "/umbraco/aireframe/api/v1/whatsMyName",
      ...e
    });
  }
  static whatsTheTimeMrWolf(e) {
    return (e?.client ?? l).get({
      ...
      url: "/umbraco/aireframe/api/v1/whatsTheTimeMrWolf",
      ...e
    });
  }
  static whoAmI(e) {
    return (e?.client ?? l).get({
      ...
      url: "/umbraco/aireframe/api/v1/whoAmI",
      ...e
    });
  }
}
...
}, g = (t, e, r) => e.has(t) || b("Cannot " + r), o = (t, e, r) => (g(t, e, "read from private field"), r ? r.call(t) : e.get(t)), c = (t, e, r) => e.has(t) ? b("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, r), N = (t, e, r, a) => (g(t, e, "write to private field"), e.set(t, r), r), n, f, v, _;
...
//# sourceMappingURL=dashboard.element-BkTqGWMb.js.map
