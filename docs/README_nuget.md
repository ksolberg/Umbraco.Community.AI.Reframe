...
[![GitHub license](https://img.shields.io/github/license/ksolberg/Umbraco.Community.AI.Reframe?color=8AB803)](https://github.com/ksolberg/Umbraco.Community.AI.Reframe/blob/main/LICENSE)
...
- **Crop** — instant, free and geometric. Keeps a sub-region of the original. Offered whenever it would discard a reasonable amount of content.
...
4. Preview the result, then click **Accept** to save it as a new media item beside the original.

## License

MIT — see [LICENSE](https://github.com/ksolberg/Umbraco.Community.AI.Reframe/blob/main/LICENSE).
